            ...
            >
...

                {
                    ...
                    formState.service_type === 'laboratory_home_visit' || formState.service_type ==='nursing'?
                        ...
                        rules={[{required: true, message: 'Please enter visit address'}]}/> : null
                }
                {
                ...
                {
                    formState?.service_type === 'clinic_visit' || formState?.service_type === 'physical_therapy_clinic_visit' || formState?.service_type === 'laboratory_clinic_visit' ? <div style={{marginTop: 20}}>
