        ...
        <div className={'add_medications_big_div'}>
            ...
            >
                ...
                <div style={{display: 'flex', gap: 8, marginTop:-16}}>
                    <div style={{width: '50%'}}>
                        <FormInput label={t('Times/Day')} name={'frequency'} initialValue={data?.frequency} rules={[{required: true}]} />
                    </div>
                    <div style={{width: '50%'}}>
                        <FormInput label={t('Duration, days')} name={'duration'} initialValue={data?.duration} rules={[{required: true}]}/>
                    </div>

                    <div style={{width: '50%'}}>
                        <FormInput label={t('Dose')} name={'dose'} initialValue={data?.dose} rules={[{required: true}]}/>
                    </div>
                    <div style={{width: '50%'}}>
