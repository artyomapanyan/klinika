...
import ClinicManagerTableHead from "../ClinicManagerAppointmentsTable/Fregment/ClinicManagerTableHead";
...
function LabTechnicianAppointmentTable() {
                    ...
                    <ResourceTable
                        ...
                        tableColumns={[{
                            ...
                            },
                            {
                                ...
                                key: 'samples',
                                render:(e, record) => {
                                    return <img alt={'Active_icon'} src={Active_icon}/>
                                }
                            },
                            {
                                title: t('Results'),
...
export default LabTechnicianAppointmentTable;