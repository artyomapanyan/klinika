...
function ColorSelect({items=[],initialValue,onChange=null, resource, record,name}){
    ...
    return<Dropdown
        ...
        trigger={['click']}
    >
        <Space direction={'horizontal'} style={{cursor:"pointer", backgroundColor:value === '2' ? "#a7a8a7" : "#ce4e99", padding:10, borderRadius:30, width:150, display:"flex", flexDirection:"row", justifyContent:"space-between"}}>
